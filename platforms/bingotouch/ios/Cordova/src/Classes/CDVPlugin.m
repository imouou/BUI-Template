...
extern NSString* const CDVPageDidLoadNotification = @"CDVPageDidLoadNotification";
extern NSString* const CDVPluginHandleOpenURLNotification = @"CDVPluginHandleOpenURLNotification";
extern NSString* const CDVPluginResetNotification = @"CDVPluginResetNotification";
extern NSString* const CDVLocalNotification = @"CDVLocalNotification";
